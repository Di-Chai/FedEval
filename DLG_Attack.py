...
arg_parse.add_argument('--attack_epoch', type=int, default=5000)
...
arg_parse.add_argument('--fname', type=str, default='debug')
...
client_model = LeNet(inputs_shape={'x': x_train.shape[1:]},
                     targets_shape={'y': y_train.shape[1:]},
                     activation=None, optimizer='gd',
                     lr=client_lr, gpu_device='0')

client_model.build(init_vars=True)

server_model = LeNet(inputs_shape={'x': x_train.shape[1:]},
                     targets_shape={'y': y_train.shape[1:]},
                     activation=None,  optimizer='gd',
                     lr=args.server_lr, gpu_device='0')
