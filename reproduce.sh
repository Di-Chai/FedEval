...
# MNIST IID
# python3 -W ignore trial.py -d mnist -s FedSGD -c configs/workstation -m server -i false -r 10 -e run
...
python3 -W ignore trial.py -d mnist -s FedProx -c configs/workstation -m server -i true -n 1 -r 10 -e run
...
python3 -W ignore trial.py -d femnist -s FedProx -c configs/workstation -m server -i true -r 10 -e run
...
python3 -W ignore trial.py -d celeba -s FedProx -c configs/workstation -m server -i true -r 10 -e run

# Sent140 IID
# python3 -W ignore trial.py -d semantic140 -s FedSGD -c configs/workstation -m server -i false -r 10 -e run
# python3 -W ignore trial.py -d semantic140 -s FedAvg -c configs/workstation -m server -i false -r 10 -e run
...
python3 -W ignore trial.py -d semantic140 -s FedProx -c configs/workstation -m server -i true -r 10 -e run
