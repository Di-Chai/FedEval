...
"""
LocalCentral Tuning Learning Rates
    ...
    os.system("python -W ignore trial.py -d femnist -s LocalCentral "
              "-c configs/quickstart -m local -i false -t lr -r 1 -l log/tunelr -e run")
    os.system("python -W ignore trial.py -d celeba -s LocalCentral "
              "-c configs/quickstart -m local -i false -t lr -r 1 -l log/tunelr -e run")
    os.system("python -W ignore trial.py -d semantic140 -s LocalCentral "
              "-c configs/quickstart -m local -i false -t lr -r 1 -l log/tunelr -e run")
"""

"""
MNSIT and FEMNSIT Tuning Learning Rates
...
if host_name == 'gpu05':
    ...
    os.system("python3 -W ignore trial.py -d shakespeare -s FedSTC "
              "-c configs/quickstart -m local -i false -t lr -r 1 -l log/tunelr -e run")
    os.system("python3 -W ignore trial.py -d shakespeare -s FedProx "
              "-c configs/quickstart -m local -i false -t lr -r 1 -l log/tunelr -e run")
