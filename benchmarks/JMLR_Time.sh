...
sudo $FED_EVAL_PYTHON trial.py -s FedSGD -r $FED_EVAL_REPEAT -l $FED_EVAL_LOG_DIR -c configs/quickstart -m local -i true -e run -d sentiment140
...
sudo $FED_EVAL_PYTHON trial.py -s FedSTC -r $FED_EVAL_REPEAT -l $FED_EVAL_LOG_DIR -c configs/quickstart -m local -i true -e run -d sentiment140
...
sudo $FED_EVAL_PYTHON trial.py -s FedAvg -r $FED_EVAL_REPEAT -l $FED_EVAL_LOG_DIR -c configs/quickstart -m local -i true -e run -d sentiment140
...
sudo $FED_EVAL_PYTHON trial.py -s FedOpt -r $FED_EVAL_REPEAT -l $FED_EVAL_LOG_DIR -c configs/quickstart -m local -i true -e run -d sentiment140
...
sudo $FED_EVAL_PYTHON trial.py -s FedProx -r $FED_EVAL_REPEAT -l $FED_EVAL_LOG_DIR -c configs/quickstart -m local -i true -e run -d sentiment140
